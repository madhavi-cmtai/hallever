        ...
        <section className="py-20 bg-gray-50">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 max-w-6xl mx-auto">
                        ...
                        <div className="space-y-6">
                            {["phone", "whatsapp", "email"].map((key, index) => {
                                ...
                                return (
                                    <div
                                        key={key}
                                        className="p-6 bg-card rounded-2xl border border-border hover:shadow-md transition duration-300"
                                    >
                                        <div className="flex items-center gap-4">
                                            ...
                                            <Button className="rounded-full bg-[var(--primary-red)] text-white hover:bg-red-700">
                    ...
                    {/* Form */}
                    <div className="bg-card p-8 h-[500px] rounded-xl border border-border mt-14 shadow-sm max-w-xl mx-auto">
                        ...
                        <form className="space-y-4">
                            ...
                            <Button className="w-full rounded-full bg-[var(--primary-red)] text-white text-sm py-2.5 hover:bg-red-700 group">
